...
using static TravelAgency.Infrastructure.Outbox.ExecutionStatus;

namespace TravelAgency.Persistence.Repositories;

public sealed class OutboxRepository(TravelAgencyDbContext dbContext, TimeProvider timeProvider) : IOutboxRepository
{
