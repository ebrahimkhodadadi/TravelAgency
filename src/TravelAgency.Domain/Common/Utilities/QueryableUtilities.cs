...
using static TravelAgency.Domain.Common.DataProcessing.FilterByEntry;
using static TravelAgency.Domain.Common.Utilities.ExpressionUtilities;
using static TravelAgency.Domain.Common.Constants.Constants.Type;
