...
{
    private const string Issuer = nameof(TravelAgency);
    ...
    {
        var twoFactorAuthorization = new TwoFactorAuth(Issuer, codeLength, periodInSeconds, Algorithm.SHA1, new QRCoderQRCodeProvider());
