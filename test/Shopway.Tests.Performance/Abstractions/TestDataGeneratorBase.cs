...
namespace TravelAgency.Tests.Performance.Abstractions;

public abstract class TestDataGeneratorBase(IUnitOfWork<TravelAgencyDbContext> unitOfWork)
{
    protected readonly IUnitOfWork<TravelAgencyDbContext> _unitOfWork = unitOfWork;
