...
using static TravelAgency.Application.Features.Products.Commands.BatchUpsertProduct.BatchUpsertProductCommand;

namespace TravelAgency.Tests.Integration.Constants;
