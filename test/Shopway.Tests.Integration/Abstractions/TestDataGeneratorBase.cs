...
using TravelAgency.Domain.Orders;
...
{
    protected readonly IUnitOfWork<TravelAgencyDbContext> _unitOfWork;
    protected const string AUTO_PREFIX = "auto";
    protected const int Length = 22;
    protected readonly Random _random = new();

    public TestDataGeneratorBase(IUnitOfWork<TravelAgencyDbContext> unitOfWork)
    {
